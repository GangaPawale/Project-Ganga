...
var elements = document.getElementsByClassName("page11-left-inner");
const elementarr = Array.from(elements);
console.log(elementarr)
elementarr.forEach(function (ele) {
  console.log(ele)
  gsap.to(ele, {
    scrollTrigger: {
      trigger: ele,
...
const cardContainer = document.querySelector(".page12-card-container");
const card=document.querySelector(".page12-card-container>.card");
...
card.addEventListener("mouseenter", function (dets) {
  ...
  cursorFollow.style.scale = 1;
  
  // cursorFollow.style.top=`${dets.y}px`;
  // cursorFollow.style.left=`${dets.y}px`;
